...
export default function Navbar() {
  ...
  // components/layout/Navbar.tsx (Solo el bloque return)

return (
  <nav className="border-b border-white/10 bg-black/70 backdrop-blur-md sticky top-0 z-50 transition-all duration-300">
